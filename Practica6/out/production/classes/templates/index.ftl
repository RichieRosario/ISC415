...
<div class="container col-6 card" style="position:relative;width:480px">
    <div class="card-body ">
        <h5>Contacta un administrador</h5>
        <hr>
    ...
    $(".load_page").click(function(){
        ...
        $.getJSON( "/page/" + current_page, function( data ) {
            ...
            for(var i = 0; i < data.length; i++){
                ...
                var template = ' <center><div class="row"><div class="container"><div class="card my-4" style="width:480px"><div class="card-header"><h3 class="d-inline">'+titulo+'</h3></div>'
