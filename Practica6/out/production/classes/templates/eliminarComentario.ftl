...
<div class="modal-body">
        <form class="form" method="POST" action="/eliminarComentario">
            <div class="form-group">
              <p>Esta seguro que desea eliminar el comentario: ${id}
                  de contenido:${comentario?string["0"]}, y autor: ${autor} ?</p>
