      ...
      <div class="container">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                   <form class="form" action="/usuarios/nuevo" method="post">
                   <div class="form-group">
                       <label  for="username">Nombre de usuario</label><input type="text" class="form-control input-sm" placeholder="Nombre de usuario" id="username" name="username">
                       </div>

                        <div class="form-group">  
                          
                              <label  for="password">Contraseña</label><input type="password" class="form-control input-sm" placeholder="Contraseña" id="password" name="password">
                       </div>
                        <div class="form-group">  

                               <label for="nombre">Nombre y Apellido</label><input type="text" class="form-control input-sm" placeholder="John Doe" id="nombre" name="nombre">
                       </div>

                                  <div class="form-group">  

                               <label for="nombre">Permisos:</label>
                               <input type="radio" class="inline" name="rol" value="administrator"> Administrador
                                <input type="radio" class="inline" name="rol" value="autor"> Autor
                                        </div>
