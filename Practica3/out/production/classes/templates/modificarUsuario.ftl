...
<#if autenticado==true>
    <div class="container-fluid">
        ...
        <form class="form" method="POST" action="/usuarios/editar/${usuarios.getId()}">
            <div class="form-group">
                <input id="id"
                type="hidden"
                class="form-control"
                       name="id"
                       placeholder="000001" title="XXXXXXXX"
...
<#else > <p> No tiene permisos para acceder este sitio.</p>
</#if>
    ...
    <div id="loginModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="/usuarios/editar/${usuarios.getId()}" method="post">
                        <div class="form-group">
