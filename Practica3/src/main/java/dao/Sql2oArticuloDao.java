...
public class Sql2oArticuloDao implements ArticuloDao {
    ...
    public void add(Articulo articulo){
        ...
        String sql = "INSERT INTO articulos (id, titulo, cuerpo, autorId, fecha) VALUES (:id, :titulo, " +
    ...
    public void update(Articulo articulo) {
        ...
        String sql = "UPDATE articulos set titulo = :titulo, cuerpo= :cuerpo, autorId= :autorId, " +
