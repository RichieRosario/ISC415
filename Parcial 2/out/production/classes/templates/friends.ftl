            ...
            <ul class="nav top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="notification dropdown-toggle" href="index.html#">
                        ...
                        <span class="badge bg-theme"><c:out value="${numeroNotificaciones}"></c:out></span>
                    </a>
                    <ul class="dropdown-menu extended tasks-bar">
                        <div class="notify-arrow notify-arrow-green"></div>
                        <li>
                            <p class="green">You have <c:out value="${numeroNotificaciones}"></c:out> pending notifications</p>
                        </li>
                        <#list notificaciones as notification>
                            <li>
                                <#--<a href="post/${notification.getPosts().getPostId()}">-->
                                    <div class="task-info">
                                        <div class="desc">${notification.getNotificacion()}</div>
                                    </div>
                                <#--</a>-->
                            </li>
                        </#list>
                        ...
                        <div class="row mtpost">
                            <div class="form-panel">
                                <form:form method="POST" action="unFriend">
                                    <a href="profile/${person.getId()}"><h3><i class="fa fa-angle-right"></i>
                                    ...
                                    <a href="getMessage?personId=${person.getId()}" class="pull-right btn btn-warning btn-sm">Send Message</a></h3>
                                </form:form>
