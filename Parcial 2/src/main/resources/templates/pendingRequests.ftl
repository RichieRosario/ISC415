            ...
            <ul class="nav top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
                        ...
                        <span class="badge bg-theme">${numeroNotificaciones}</span>
                    </a>
                    <ul class="dropdown-menu extended tasks-bar">
                        <div class="notify-arrow notify-arrow-green"></div>
                        <li>
                            <p class="green">You have ${numeroNotificaciones} pending notifications</p>
                        </li>
                            ...
                            <#list notificaciones as notification>
	                            <li>
                                    <#--<a href="post?postId=${notification.posts.postId}">-->
                                        <div class="task-info">
                                            <div class="desc">${notification.notificacion}</div>
                                        </div>
                                    </a>
                                </li>
                            </#list>
                ...
                <#--<li id="header_inbox_bar" class="dropdown">-->
                    <#--&lt;#&ndash;<a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">&ndash;&gt;-->
                        <#--&lt;#&ndash;<i class="fa-white fa-envelope-o"></i>&ndash;&gt;-->
                        <#--&lt;#&ndash;<span class="badge bg-theme">${messageCount}</span>&ndash;&gt;-->
                    <#--&lt;#&ndash;</a>&ndash;&gt;-->
                    <#--&lt;#&ndash;<ul class="dropdown-menu extended inbox">&ndash;&gt;-->
                        <#--&lt;#&ndash;<div class="notify-arrow notify-arrow-green"></div>&ndash;&gt;-->
                        <#--&lt;#&ndash;<li>&ndash;&gt;-->
                            <#--&lt;#&ndash;<p class="green">You have ${messageCount} new messages</p>&ndash;&gt;-->
                        <#--&lt;#&ndash;</li>&ndash;&gt;-->

							<#--&lt;#&ndash;<#list messageList as person>&ndash;&gt;-->
	                            <#--&lt;#&ndash;<li>&ndash;&gt;-->
                                    <#--&lt;#&ndash;<a href="getMessage?personId=${person.pId}">&ndash;&gt;-->
                                        <#--&lt;#&ndash;<div class="task-info">&ndash;&gt;-->
                                            <#--&lt;#&ndash;<div class="desc">${person.firstName} ${person.lastName}</div>&ndash;&gt;-->
                                        <#--&lt;#&ndash;</div>&ndash;&gt;-->
                                    <#--&lt;#&ndash;</a>&ndash;&gt;-->
                                <#--&lt;#&ndash;</li>&ndash;&gt;-->
                            <#--&lt;#&ndash;</#list>&ndash;&gt;-->
                        ...
                        <#--&lt;#&ndash;<li>&ndash;&gt;-->
                            <#--&lt;#&ndash;<a href="index.html#">See all messages</a>&ndash;&gt;-->
                        <#--&lt;#&ndash;</li>&ndash;&gt;-->
                    <#--&lt;#&ndash;</ul>&ndash;&gt;-->
                <#--</li>-->
                <!-- inbox dropdown end -->
    ...
    <aside>
        <div id="sidebar"  class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <p class="centered"><a href="profile/${user.getUsername()}"><h5 class="centered">${profile.getNombre()} ${profile.getApellido()}</h5></a></p>
                  ...
                  <div class="form-panel">
                      <form:form method="GET" action="profile">
                        ...
                        <#--<#else><img src="" width=150 height=150 class="img-circle" /></#if>-->
                              ${profile.getNombre()} ${profile.getApellido()}
