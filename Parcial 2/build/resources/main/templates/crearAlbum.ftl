...
<div class="card mx-auto"style="width:50%">
    ...
    <div class="card-body">
        ...
        <form method="post"  enctype='multipart/form-data' action="/crearAlbum">
            ...
            <div class="form-group">
                <input type="text" id="descripcion" name="descripcion" class="mx-auto form-control" placeholder="Descripcion de album">
            </div>

            <select class="js-example-basic-multiple form-control" name="amigos[]" multiple="multiple">
